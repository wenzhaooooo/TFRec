...
if __name__ == "__main__":
    dataloader = DataIterator(list(range(10)), list(range(10, 20)), batch_size=3, shuffle=False, drop_last=False)
    for data in dataloader:
        print(data)

    print()
    dataloader = DataIterator(list(range(10)), list(range(10, 20)), batch_size=3, shuffle=True, drop_last=True)
    for data in dataloader:
        print(data)
